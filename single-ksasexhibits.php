	...
	<section class="content">
		<h3><?php the_title(); ?></h3>
			...
			<div class="small-12 columns">
				<div id="featured">
					<ul id="slider" data-orbit data-options="animation: fade; animationSpeed:1000; timer:true; advanceSpeed:8000; navigation_arrows:true; bullets:false; slide_number:false;" class="exhibit-slide">
					<?php $args = array( 
